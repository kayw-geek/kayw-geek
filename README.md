...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.320.8](https://github.com/aws/aws-sdk-php/releases/tag/3.320.8), 1 day ago) - Official repository of the AWS SDK for PHP (@awsforphp)
- [PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ([v3.63.1](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.63.1), 1 day ago) - A tool to automatically fix PHP Coding Standards issues
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v9.4.0](https://github.com/orchestral/testbench-core/releases/tag/v9.4.0), 1 day ago) - Testing Helper for Laravel Development
...
- [Resolve the `symfony/config` compatibility](https://github.com/symplify/monorepo-builder/pull/74) on [symplify/monorepo-builder](https://github.com/symplify/monorepo-builder) (4 days ago)
- [Optimize the composer properties sorting](https://github.com/symplify/monorepo-builder/pull/73) on [symplify/monorepo-builder](https://github.com/symplify/monorepo-builder) (6 days ago)
...
- [shadps4-emu/shadPS4](https://github.com/shadps4-emu/shadPS4) - PS4 emulator for Windows,Linux,MacOS (5 days ago)
- [s0md3v/roop](https://github.com/s0md3v/roop) - one-click face swap (6 days ago)
