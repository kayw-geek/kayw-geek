...
- [jdalrymple/gitbeaker](https://github.com/jdalrymple/gitbeaker) - 🦊🧪 A comprehensive and typed Gitlab SDK for Node.js, Browsers, Deno and CLI  (5 days ago)
...
- [larastan/larastan](https://github.com/larastan/larastan) ([v3.4.1](https://github.com/larastan/larastan/releases/tag/v3.4.1), 1 day ago) - ⚗️ Adds code analysis to Laravel improving developer productivity and code quality.
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.344.3](https://github.com/aws/aws-sdk-php/releases/tag/3.344.3), 1 day ago) - Official repository of the AWS SDK for PHP (@awsforphp)
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v10.4.0](https://github.com/orchestral/testbench-core/releases/tag/v10.4.0), 2 days ago) - The Testing Framework for Laravel Development
- [laravel/framework](https://github.com/laravel/framework) ([v12.17.0](https://github.com/laravel/framework/releases/tag/v12.17.0), 1 week ago) - The Laravel Framework.
...
- [Add missing `detailed_status` field to WebhookPipelineEventSchema](https://github.com/jdalrymple/gitbeaker/pull/3729) on [jdalrymple/gitbeaker](https://github.com/jdalrymple/gitbeaker) (5 days ago)
...
- [nunomaduro/essentials](https://github.com/nunomaduro/essentials) - Just better defaults for your Laravel projects. (4 days ago)
...
- [onlook-dev/onlook](https://github.com/onlook-dev/onlook) - The Cursor for Designers • An Open-Source Visual Vibecoding Editor • Visually build, style, and edit your React App with AI (5 days ago)
