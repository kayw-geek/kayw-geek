...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.340.0](https://github.com/aws/aws-sdk-php/releases/tag/3.340.0), today) - Official repository of the AWS SDK for PHP (@awsforphp)
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v10.0.1](https://github.com/orchestral/testbench-core/releases/tag/v10.0.1), today) - The Testing Framework for Laravel Development
- [laravel/framework](https://github.com/laravel/framework) ([v12.0.1](https://github.com/laravel/framework/releases/tag/v12.0.1), today) - The Laravel Framework.
...
- [dmaicher/doctrine-test-bundle](https://github.com/dmaicher/doctrine-test-bundle) - Symfony bundle to isolate your app&#39;s doctrine database tests and improve the test performance (4 days ago)
