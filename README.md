...
- [laravel/framework](https://github.com/laravel/framework) ([v12.65.0](https://github.com/laravel/framework/releases/tag/v12.65.0), 5 days ago) - Laravel is a web application framework with expressive, elegant syntax.
...
- [zqxwce/vphone-ws](https://github.com/zqxwce/vphone-ws) - A native macOS app for managing virtual iPhones - browse, create, and boot iOS research VMs from a single window. (5 days ago)
