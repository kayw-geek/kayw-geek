...
- [symplify/monorepo-builder](https://github.com/symplify/monorepo-builder) ([12.7.2](https://github.com/symplify/monorepo-builder/releases/tag/12.7.2), 1 day ago) - Composer tools to maintain a monorepo
...
- [laravel/framework](https://github.com/laravel/framework) ([v13.23.0](https://github.com/laravel/framework/releases/tag/v13.23.0), 5 days ago) - Laravel is a web application framework with expressive, elegant syntax.
...
- [mintdotgg/mint-playground](https://github.com/mintdotgg/mint-playground) - Open-source Three.js experiences built with Mint MCP and Mint Three.js Skills (3 days ago)
- [phpstan/turbo-ext](https://github.com/phpstan/turbo-ext) - [READ ONLY] Split of turbo-ext directory from phpstan-src repository. phpstan_turbo is a native acceleration extension for PHPStan. (4 days ago)
