...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.343.10](https://github.com/aws/aws-sdk-php/releases/tag/3.343.10), today) - Official repository of the AWS SDK for PHP (@awsforphp)
- [laravel/framework](https://github.com/laravel/framework) ([v12.14.1](https://github.com/laravel/framework/releases/tag/v12.14.1), today) - The Laravel Framework.
