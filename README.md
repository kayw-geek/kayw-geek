...
- [larastan/larastan](https://github.com/larastan/larastan) ([v3.9.0](https://github.com/larastan/larastan/releases/tag/v3.9.0), 2 days ago) - ⚗️ Adds code analysis to Laravel improving developer productivity and code quality.
- [laravel/framework](https://github.com/laravel/framework) ([v12.47.0](https://github.com/laravel/framework/releases/tag/v12.47.0), 1 week ago) - The Laravel Framework.
...
- [iconify/iconify](https://github.com/iconify/iconify) - Universal icon framework. One syntax for FontAwesome, Material Design Icons, DashIcons, Feather Icons, EmojiOne, Noto Emoji and many other open source icon sets (over 150 icon sets and 200k icons). SVG framework, React, Vue and Svelte components! (1 day ago)
