...
- [laravel/framework](https://github.com/laravel/framework) ([v11.34.1](https://github.com/laravel/framework/releases/tag/v11.34.1), today) - The Laravel Framework.
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.330.2](https://github.com/aws/aws-sdk-php/releases/tag/3.330.2), today) - Official repository of the AWS SDK for PHP (@awsforphp)
