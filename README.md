...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.331.0](https://github.com/aws/aws-sdk-php/releases/tag/3.331.0), today) - Official repository of the AWS SDK for PHP (@awsforphp)
...
- [Hammerspoon/hammerspoon](https://github.com/Hammerspoon/hammerspoon) - Staggeringly powerful macOS desktop automation with Lua (today)
...
- [RimoChan/fsspec_disk](https://github.com/RimoChan/fsspec_disk) - 万能硬盘！ (5 days ago)
...
- [ycvk/deeplx-local](https://github.com/ycvk/deeplx-local) - 自建deeplx服务 (6 days ago)
- [LufsX/rime](https://github.com/LufsX/rime) - Rime（中州韵）全拼与双拼的自用配置方案 (6 days ago)
