...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.314.6](https://github.com/aws/aws-sdk-php/releases/tag/3.314.6), today) - Official repository of the AWS SDK for PHP (@awsforphp)
...
- [staabm/phpstan-dba](https://github.com/staabm/phpstan-dba) - PHPStan based SQL static analysis and type inference for the database access layer (today)
