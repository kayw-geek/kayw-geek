...
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v9.8.2](https://github.com/orchestral/testbench-core/releases/tag/v9.8.2), today) - The Testing Framework for Laravel Development
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.336.0](https://github.com/aws/aws-sdk-php/releases/tag/3.336.0), 1 day ago) - Official repository of the AWS SDK for PHP (@awsforphp)
...
- [amzxyz/RIME-LMDG](https://github.com/amzxyz/RIME-LMDG) - Rime输入法语言模型全流程构建教程，全局带声调词库，最全带读音单字表词典：LMDG - Language, Model, Dictionary, Grammar (1 day ago)
- [nishuzumi/gemini-teacher](https://github.com/nishuzumi/gemini-teacher) - English pronunciation correction teacher built with gemini (1 day ago)
...
- [teslamate-org/teslamate](https://github.com/teslamate-org/teslamate) - A self-hosted data logger for your Tesla  🚘 (3 days ago)
