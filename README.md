...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.343.18](https://github.com/aws/aws-sdk-php/releases/tag/3.343.18), 2 days ago) - Official repository of the AWS SDK for PHP (@awsforphp)
- [laravel/framework](https://github.com/laravel/framework) ([v11.45.0](https://github.com/laravel/framework/releases/tag/v11.45.0), 5 days ago) - The Laravel Framework.
...
- [GeoSn0w/iDevice-Toolkit](https://github.com/GeoSn0w/iDevice-Toolkit) - The official repo for iDevice Toolkit, my iOS tweaking / customization tool for iOS 16.0 - 18.5 (2 days ago)
- [infection/infection](https://github.com/infection/infection) - PHP Mutation Testing library (3 days ago)
- [Belco90/octochangelog](https://github.com/Belco90/octochangelog) - Compare GitHub changelogs across multiple releases in a single view. (3 days ago)
- [php-mcp/server](https://github.com/php-mcp/server) - Core PHP implementation for the Model Context Protocol (MCP) server (4 days ago)
- [imliam/cpx](https://github.com/imliam/cpx) - Run any command from any composer package, even if it&#39;s not installed in your project. (4 days ago)
