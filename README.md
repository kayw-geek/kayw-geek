...
- [laravel/framework](https://github.com/laravel/framework) ([v12.45.2](https://github.com/laravel/framework/releases/tag/v12.45.2), today) - The Laravel Framework.
...
- [teslamotors/custom-wraps](https://github.com/teslamotors/custom-wraps) -  (2 days ago)
- [youhunwl/TVAPP](https://github.com/youhunwl/TVAPP) -  收集全网 Android TV电视盒子应用，涵盖影视、直播、K歌、工具、游戏等类型，整理优质APK资源，支持便捷下载与自动更新。提供安全验证、分类索引与兼容性标注，助力用户打造家庭影音娱乐中心！              ✅ TVBox/影视仓等影音壳接口配置源。 (2 days ago)
- [cameroncooke/AXe](https://github.com/cameroncooke/AXe) - AXe is a CLI tool for interacting with Simulators using Apple&#39;s Private Accessibility APIs. (2 days ago)
