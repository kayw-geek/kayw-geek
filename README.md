...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.342.30](https://github.com/aws/aws-sdk-php/releases/tag/3.342.30), 2 days ago) - Official repository of the AWS SDK for PHP (@awsforphp)
...
- [jasonmccreary/laravel-test-assertions](https://github.com/jasonmccreary/laravel-test-assertions) - A set of helpful assertions when testing Laravel applications. (6 days ago)
- [jamez-bondos/awesome-gpt4o-images](https://github.com/jamez-bondos/awesome-gpt4o-images) - Awesome curated collection of GPT-4o images &amp; prompts. Explore diverse AI-generated art styles (Ghibli, 3D, etc.) from OpenAI&#39;s latest model.  (6 days ago)
