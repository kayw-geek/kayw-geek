...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.343.1](https://github.com/aws/aws-sdk-php/releases/tag/3.343.1), 1 day ago) - Official repository of the AWS SDK for PHP (@awsforphp)
- [laravel/framework](https://github.com/laravel/framework) ([v12.11.1](https://github.com/laravel/framework/releases/tag/v12.11.1), 1 day ago) - The Laravel Framework.
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v10.2.2](https://github.com/orchestral/testbench-core/releases/tag/v10.2.2), 4 days ago) - The Testing Framework for Laravel Development
...
- [JetBrains/mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains) - A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio (3 days ago)
- [slack-php/slack-php-block-kit](https://github.com/slack-php/slack-php-block-kit) - OOP interface for composing Slack Block Kit messages and modals in PHP (6 days ago)
