...
- [laravel/framework](https://github.com/laravel/framework) ([v12.50.0](https://github.com/laravel/framework/releases/tag/v12.50.0), 3 days ago) - Laravel is a web application framework with expressive, elegant syntax.
- [larastan/larastan](https://github.com/larastan/larastan) ([v3.9.2](https://github.com/larastan/larastan/releases/tag/v3.9.2), 5 days ago) - ⚗️ Adds code analysis to Laravel improving developer productivity and code quality.
...
- [foru17/clash-master](https://github.com/foru17/clash-master) - A modern and elegant dashboard for visualizing and managing Clash network traffic. (1 day ago)
...
- [cucumber/cucumber-js](https://github.com/cucumber/cucumber-js) - Cucumber for JavaScript (2 days ago)
...
- [Jarred-Sumner/mactrace](https://github.com/Jarred-Sumner/mactrace) - Minimal strace for macOS - trace system calls of any process using Instruments. (3 days ago)
- [steipete/Trimmy](https://github.com/steipete/Trimmy) - &#34;Paste once, run once.&#34; — Trimmy flattens those multi-line shell snippets you copy so they actually paste and run. (3 days ago)
- [jeffernn/Joyflix-Mac-Objective-C](https://github.com/jeffernn/Joyflix-Mac-Objective-C) - Joyflix平台 - Mac客户端  内置各大精品站，CCTV电视直播频道,各平台直播聚合，提供屏蔽站点广告特性。 (3 days ago)
