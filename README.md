...
- [laravel/framework](https://github.com/laravel/framework) ([v13.21.1](https://github.com/laravel/framework/releases/tag/v13.21.1), 2 days ago) - Laravel is a web application framework with expressive, elegant syntax.
- [rudderlabs/rudder-php-sdk](https://github.com/rudderlabs/rudder-php-sdk) ([v2.2.0](https://github.com/rudderlabs/rudder-php-sdk/releases/tag/v2.2.0), 2 days ago) - RudderStack&#39;s PHP SDK for effective server-side event tracking.
