...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.343.1](https://github.com/aws/aws-sdk-php/releases/tag/3.343.1), today) - Official repository of the AWS SDK for PHP (@awsforphp)
...
- [JetBrains/mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains) - A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio (2 days ago)
- [slack-php/slack-php-block-kit](https://github.com/slack-php/slack-php-block-kit) - OOP interface for composing Slack Block Kit messages and modals in PHP (5 days ago)
