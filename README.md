...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.320.7](https://github.com/aws/aws-sdk-php/releases/tag/3.320.7), 2 days ago) - Official repository of the AWS SDK for PHP (@awsforphp)
...
- [Resolve the `symfony/config` compatibility](https://github.com/symplify/monorepo-builder/pull/74) on [symplify/monorepo-builder](https://github.com/symplify/monorepo-builder) (2 days ago)
- [Optimize the composer properties sorting](https://github.com/symplify/monorepo-builder/pull/73) on [symplify/monorepo-builder](https://github.com/symplify/monorepo-builder) (4 days ago)
...
- [s0md3v/roop](https://github.com/s0md3v/roop) - one-click face swap (4 days ago)
