...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.322.3](https://github.com/aws/aws-sdk-php/releases/tag/3.322.3), 1 day ago) - Official repository of the AWS SDK for PHP (@awsforphp)
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v9.5.0](https://github.com/orchestral/testbench-core/releases/tag/v9.5.0), 1 day ago) - Testing Helper for Laravel Development
