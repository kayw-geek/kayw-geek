...
- [PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ([v3.69.0](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.69.0), 1 day ago) - A tool to automatically fix PHP Coding Standards issues
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v9.10.0](https://github.com/orchestral/testbench-core/releases/tag/v9.10.0), 1 day ago) - The Testing Framework for Laravel Development
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.339.14](https://github.com/aws/aws-sdk-php/releases/tag/3.339.14), 2 days ago) - Official repository of the AWS SDK for PHP (@awsforphp)
...
- [fatwang2/siri-ultra](https://github.com/fatwang2/siri-ultra) - The most intelligent Siri powered by LLMs (6 days ago)
