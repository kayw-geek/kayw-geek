...
- [laravel/framework](https://github.com/laravel/framework) ([v13.30.1](https://github.com/laravel/framework/releases/tag/v13.30.1), 1 week ago) - Laravel is a web application framework with expressive, elegant syntax.
...
- [yanliudesign/mono-color-skill](https://github.com/yanliudesign/mono-color-skill) - One-ink editorial print image skill — warm paper, halftone photography, active negative space, and restrained typography. (4 days ago)
- [Do1e/mijia-api](https://github.com/Do1e/mijia-api) - 使用代码、CLI、MCP 直接控制米家设备。 (6 days ago)
...
- [Evianis/travel-photo-abstraction](https://github.com/Evianis/travel-photo-abstraction) - A source-available Codex skill for distilling photographs into sparse editorial abstractions. (4 weeks ago)
