...
- [laravel/framework](https://github.com/laravel/framework) ([v12.65.0](https://github.com/laravel/framework/releases/tag/v12.65.0), 4 days ago) - Laravel is a web application framework with expressive, elegant syntax.
...
- [zqxwce/vphone-ws](https://github.com/zqxwce/vphone-ws) - A native macOS app for managing virtual iPhones - browse, create, and boot iOS research VMs from a single window. (4 days ago)
- [mayfly42/ThreatReport](https://github.com/mayfly42/ThreatReport) -  (6 days ago)
...
- [CatsJuice/sticker-forge](https://github.com/CatsJuice/sticker-forge) - A tactile WebGL sticker maker with rich text, image uploads, and interactive peel physics. (2 weeks ago)
