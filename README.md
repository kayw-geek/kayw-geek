...
- [kayw-geek/phpstan-type-trace](https://github.com/kayw-geek/phpstan-type-trace) - See the full type-inference chain of any value in PHPStan, not just a single snapshot. (2 days ago)
...
- [larastan/larastan](https://github.com/larastan/larastan) ([v3.10.0](https://github.com/larastan/larastan/releases/tag/v3.10.0), 1 day ago) - ⚗️ Adds code analysis to Laravel improving developer productivity and code quality.
...
- [laravel/framework](https://github.com/laravel/framework) ([v12.61.0](https://github.com/laravel/framework/releases/tag/v12.61.0), 3 days ago) - Laravel is a web application framework with expressive, elegant syntax.
- [kayw-geek/phpstan-type-trace](https://github.com/kayw-geek/phpstan-type-trace) ([v0.2.0](https://github.com/kayw-geek/phpstan-type-trace/releases/tag/v0.2.0), 4 days ago) - See the full type-inference chain of any value in PHPStan, not just a single snapshot.
...
- [Add kayw-geek/phpstan-type-trace to PHPStan rules index](https://github.com/TomasVotruba/tomasvotruba.com/pull/1543) on [TomasVotruba/tomasvotruba.com](https://github.com/TomasVotruba/tomasvotruba.com) (today)
- [Add kayw-geek/phpstan-type-trace to extension library](https://github.com/phpstan/phpstan/pull/14712) on [phpstan/phpstan](https://github.com/phpstan/phpstan) (1 day ago)
- [[13.x] Return FAILURE exit code when key:generate is prohibited](https://github.com/laravel/framework/pull/60273) on [laravel/framework](https://github.com/laravel/framework) (3 days ago)
- [[13.x] Restore base_path() guard in SQLiteConnector lost during merge race](https://github.com/laravel/framework/pull/60272) on [laravel/framework](https://github.com/laravel/framework) (3 days ago)
...
- [[13.x] Add Batch::addOrFail() and use in PendingBatch::dispatch()](https://github.com/laravel/framework/pull/59945) on [laravel/framework](https://github.com/laravel/framework) (4 weeks ago)
...
- [hyechow/iphone-use](https://github.com/hyechow/iphone-use) - iphone use agent on mac (2 days ago)
- [dontbesilent2025/dbskill](https://github.com/dontbesilent2025/dbskill) - dontbesilent 的商业诊断 Skills (4 days ago)
- [zeroxjf/cyanide-ios](https://github.com/zeroxjf/cyanide-ios) - Cyanide — iOS tweak runner built on top of the DarkSword kernel r/w exploit (4 days ago)
