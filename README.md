...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.323.2](https://github.com/aws/aws-sdk-php/releases/tag/3.323.2), 1 day ago) - Official repository of the AWS SDK for PHP (@awsforphp)
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v9.5.3](https://github.com/orchestral/testbench-core/releases/tag/v9.5.3), 2 days ago) - Testing Helper for Laravel Development
...
- [[11.x] Fix incorrect variable-length argument `$guards` from array to string](https://github.com/laravel/framework/pull/52719) on [laravel/framework](https://github.com/laravel/framework) (4 weeks ago)
