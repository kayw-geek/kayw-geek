...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.321.11](https://github.com/aws/aws-sdk-php/releases/tag/3.321.11), 2 days ago) - Official repository of the AWS SDK for PHP (@awsforphp)
...
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v9.4.1](https://github.com/orchestral/testbench-core/releases/tag/v9.4.1), 3 days ago) - Testing Helper for Laravel Development
...
- [[11.x] Enhance PHPDoc for Eloquent Relations to support precise subclasses](https://github.com/laravel/framework/pull/52775) on [laravel/framework](https://github.com/laravel/framework) (2 days ago)
- [[11.x] Fix incorrect PHPDoc for Builder relation](https://github.com/laravel/framework/pull/52754) on [laravel/framework](https://github.com/laravel/framework) (3 days ago)
- [[11.x] Fix incorrect variable-length argument `$guards` from array to string](https://github.com/laravel/framework/pull/52719) on [laravel/framework](https://github.com/laravel/framework) (5 days ago)
...
- [zenstruck/console-extra](https://github.com/zenstruck/console-extra) - A modular set of features to reduce configuration boilerplate for your Symfony commands. (2 days ago)
- [morishin/XDeck](https://github.com/morishin/XDeck) - An 𝕏 client app for macOS as a TweetDeck (X Pro) alternative. (2 days ago)
- [x-cmd/x-cmd](https://github.com/x-cmd/x-cmd) - X bootstrap 1000&#43; tools and scripts. (2 days ago)
