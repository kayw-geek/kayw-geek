...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) - Official repository of the AWS SDK for PHP (@awsforphp) (6 days ago)
...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.314.6](https://github.com/aws/aws-sdk-php/releases/tag/3.314.6), 4 days ago) - Official repository of the AWS SDK for PHP (@awsforphp)
...
- [staabm/phpstan-dba](https://github.com/staabm/phpstan-dba) - PHPStan based SQL static analysis and type inference for the database access layer (4 days ago)
