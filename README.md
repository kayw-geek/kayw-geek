...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.342.35](https://github.com/aws/aws-sdk-php/releases/tag/3.342.35), 1 day ago) - Official repository of the AWS SDK for PHP (@awsforphp)
- [laravel/framework](https://github.com/laravel/framework) ([v11.44.7](https://github.com/laravel/framework/releases/tag/v11.44.7), 1 day ago) - The Laravel Framework.
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v9.13.2](https://github.com/orchestral/testbench-core/releases/tag/v9.13.2), 2 days ago) - The Testing Framework for Laravel Development
- [larastan/larastan](https://github.com/larastan/larastan) ([v3.4.0](https://github.com/larastan/larastan/releases/tag/v3.4.0), 4 days ago) - ⚗️ Adds code analysis to Laravel improving developer productivity and code quality.
...
- [slack-php/slack-php-block-kit](https://github.com/slack-php/slack-php-block-kit) - OOP interface for composing Slack Block Kit messages and modals in PHP (1 day ago)
