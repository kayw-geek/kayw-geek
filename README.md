...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.10.7](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.10.7), 1 day ago) - Easily install PHP extensions in Docker containers
- [laravel/framework](https://github.com/laravel/framework) ([v13.1.1](https://github.com/laravel/framework/releases/tag/v13.1.1), 2 days ago) - Laravel is a web application framework with expressive, elegant syntax.
...
- [Fix curl_close() deprecation in PHP 8.5](https://github.com/segmentio/analytics-php/pull/248) on [segmentio/analytics-php](https://github.com/segmentio/analytics-php) (3 days ago)
...
- [mbolli/php-via](https://github.com/mbolli/php-via) - Real-time engine for building reactive web applications in PHP with Swoole. (today)
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) - AI memory OS for LLM and Agent systems(moltbot,clawdbot,openclaw), enabling persistent Skill memory for cross-task skill reuse and evolution. (3 days ago)
