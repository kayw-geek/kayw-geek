...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.343.6](https://github.com/aws/aws-sdk-php/releases/tag/3.343.6), today) - Official repository of the AWS SDK for PHP (@awsforphp)
- [laravel/framework](https://github.com/laravel/framework) ([v12.13.0](https://github.com/laravel/framework/releases/tag/v12.13.0), today) - The Laravel Framework.
