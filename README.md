...
- [aws/aws-sdk-php](https://github.com/aws/aws-sdk-php) ([3.336.0](https://github.com/aws/aws-sdk-php/releases/tag/3.336.0), today) - Official repository of the AWS SDK for PHP (@awsforphp)
...
- [amzxyz/RIME-LMDG](https://github.com/amzxyz/RIME-LMDG) - Rime输入法语言模型全流程构建教程，全局带声调词库，最全带读音单字表词典：LMDG - Language, Model, Dictionary, Grammar (today)
