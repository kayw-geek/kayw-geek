...
- [laravel/framework](https://github.com/laravel/framework) ([v12.65.0](https://github.com/laravel/framework/releases/tag/v12.65.0), 1 day ago) - Laravel is a web application framework with expressive, elegant syntax.
- [symplify/monorepo-builder](https://github.com/symplify/monorepo-builder) ([12.7.2](https://github.com/symplify/monorepo-builder/releases/tag/12.7.2), 6 days ago) - Composer tools to maintain a monorepo
...
- [zqxwce/vphone-ws](https://github.com/zqxwce/vphone-ws) - A native macOS app for managing virtual iPhones - browse, create, and boot iOS research VMs from a single window. (1 day ago)
- [mayfly42/ThreatReport](https://github.com/mayfly42/ThreatReport) -  (3 days ago)
...
- [LiamGvchi/gc-minimal-zine-poster](https://github.com/LiamGvchi/gc-minimal-zine-poster) - Codex skill for generating quiet minimal zine-style editorial poster prompts and images. (2 weeks ago)
- [swoole/typephp](https://github.com/swoole/typephp) -  (2 weeks ago)
