...
- [laravel/framework](https://github.com/laravel/framework) ([v11.51.0](https://github.com/laravel/framework/releases/tag/v11.51.0), 4 days ago) - Laravel is a web application framework with expressive, elegant syntax.
- [symplify/monorepo-builder](https://github.com/symplify/monorepo-builder) ([12.5.2](https://github.com/symplify/monorepo-builder/releases/tag/12.5.2), 4 days ago) - Composer tools to maintain a monorepo
...
- [Fix workers() not respecting user-specified order](https://github.com/symplify/monorepo-builder/pull/112) on [symplify/monorepo-builder](https://github.com/symplify/monorepo-builder) (4 days ago)
